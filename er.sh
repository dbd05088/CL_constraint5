...
# CIL CONFIG
NOTE="er_imagenet_mem1281167_iter0.03125" # Short description of the experiment. (WARNING: logs/results with the same note will be overwritten!)
MODE="er"
...
do
    ...
    --dataset $DATASET --data_dir ~user/khs/ILSVRC/Data/CLS-LOC \
